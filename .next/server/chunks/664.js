...
exports.modules = {
  ...
  /***/ 2669: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';
  ...
  /***/ 387: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';
  ...
  /***/ 7190: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';
  ...
  /***/ 8981: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';
    ...
    class Router {
      ...
      async change(method, url2, as3, options2, forcedScroll) {
        ...
        const shouldResolveHref =
          options2._h ||
          options2._shouldResolveHref ||
          pathNoQueryHash(url2) === pathNoQueryHash(as3);
        ...
        as3 = addBasePath(
          addLocale(
            hasBasePath(as3) ? delBasePath(as3) : as3,
            options2.locale,
            this.defaultLocale,
          ),
        );
        ...
        if ((0, _isDynamic).isDynamicRoute(route)) {
          ...
          if (!routeMatch || (shouldInterpolate && !interpolatedAs.result)) {
            ...
            if (missingParams.length > 0) {
              ...
              throw new Error(
                (shouldInterpolate
                  ? `The provided \`href\` (${url2}) value is missing query values (${missingParams.join(
                      ', ',
            ...
            as3 = (0, _utils).formatWithValidation(
        ...
        try {
          ...
          var _scroll;
          const shouldScroll =
            (_scroll = options2.scroll) !== null && _scroll !== void 0
              ? _scroll
              : !isValidShallowRoute;
          ...
          window.history[method1](
            {
              ...
              __N: true,
              idx: (this._idx =
                method1 !== 'pushState' ? this._idx : this._idx + 1),
      ...
      async getRouteInfo(
        ...
        try {
          ...
          return this.handleRouteInfoError(
            (0, _isError).default(err) ? err : new Error(err + ''),
            pathname2,
            query2,
            as6,
            routeProps1,
            ...
            return isSsg
              ? fetchNextData(
                  this.pageLoader.getDataHref({
                    ...
                    ssg: true,
                    locale:
                      typeof options4.locale !== 'undefined'
                        ? options4.locale
                        : this.locale,
                  }),
                  false,
        ...
        const handleCancelled = () => {
          if (cancelled) {
            const error = new Error(
              `Abort fetching component for route: "${route2}"`,
            );
      ...
      async _preflightRequest(options5) {
        var ref;
        const cleanedAs = delLocale(
          hasBasePath(options5.as) ? delBasePath(options5.as) : options5.as,
          this.locale,
        );
        ...
        if (
          (ref = preflight.rewrite) === null || ref === void 0
            ? void 0
            : ref.startsWith('/')
        ) {
          ...
          if (options5.pages.includes(fsPathname)) {
            ...
            if (
              ...
              options5.pages.includes(resolvedHref)
            ) {
              matchedPage = true;
            }
          }
