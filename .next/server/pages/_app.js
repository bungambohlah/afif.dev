...
(() => {
  ...
  exports.modules = {
    /***/ 5953: /***/ (
      ...
      var jsx_runtime_ = __webpack_require__(997); // CONCATENATED MODULE: external "@badrap/bar-of-progress"
      const bar_of_progress_namespaceObject = require('@badrap/bar-of-progress');
      var bar_of_progress_default = /*#__PURE__*/ __webpack_require__.n(
        bar_of_progress_namespaceObject,
      );
      // EXTERNAL MODULE: external "@chakra-ui/react"
      var react_ = __webpack_require__(8930);
      // EXTERNAL MODULE: external "next-seo"
      var external_next_seo_ = __webpack_require__(6641); // CONCATENATED MODULE: external "next/router"
      const router_namespaceObject = require('next/router');
      var router_default = /*#__PURE__*/ __webpack_require__.n(
        router_namespaceObject,
      );
      // EXTERNAL MODULE: external "react"
      var external_react_ = __webpack_require__(6689); // CONCATENATED MODULE: ./src/constants/seo-constant.js
      const getURL = () => {
        var ref;
        const url =
          process.env && process.env.URL && process.env.URL !== ''
            ...
            : (process === null || process === void 0
                ? void 0
                : (ref = process.env) === null || ref === void 0
                ? void 0
                : ref.VERCEL_URL) && process.env.VERCEL_URL !== ''
      ...
      /* harmony default export */ const styles_theme = theme; // CONCATENATED MODULE: ./src/pages/_app.js
      ...
      const {
        ...
        TWITTER_HANDLE: _app_TWITTER_HANDLE,
      ...
      function App({ Component, pageProps, router }) {
        ...
        const Layout =
          ((ref = Component.layoutProps) === null || ref === void 0
            ? void 0
            : ref.Layout) || external_react_.Fragment;
